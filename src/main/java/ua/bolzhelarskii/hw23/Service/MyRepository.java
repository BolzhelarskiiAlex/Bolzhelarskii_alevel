...
import ua.bolzhelarskii.hw23.Objects.Device;
import ua.bolzhelarskii.hw23.Objects.Factory;
...
public class MyRepository extends AbstractRepository {
    public static void fillFactoryTable(int count) {
        try {
            String[] factoryName = {"GMC", "KIKO", "STAFF", "PEPER"};
            String[] factoryCountry = {"USA", "China", "Ukraine", "France"};
            PreparedStatement preparedStatement = null;
            for (int i = 0; i < count; i++) {
                String sql = "INSERT INTO factory (factory_id, name, country) VALUES (?, ?, ?);";
    ...
    public static void fillDeviceTable(int count) {
        try {
            ...
            PreparedStatement preparedStatement = null;
            for (int i = 0; i < count; i++) {
                String sql = "INSERT INTO `device` (`device_id`, `type`, " +
    ...
    public static void updateDevice(String id, String column, String value) {
        try {
            String sql = String.format("UPDATE `device` SET %s = ? " +
